    ...
    */
    _initWidgetComponents: function () {
      ...
      if (this.config.editorDescription) {
        this.searchHeaderTextNode.innerHTML = this.config.editorDescription;
      }
      ...
      this.own(on(this.filterBackButton, "click", lang.hitch(this, function () {
        this._filterBackButtonClicked();
        this._itemListObject.filterButton.focus();
      })));
      this.own(on(this.filterBackButton, "keydown", lang.hitch(this, function (evt) {
    ...
    /**
     * Function to be called once the back button in the filter panel is clicked
     */
    _filterBackButtonClicked: function () {
    ...
    **/
    _initLayerList: function () {
      ...
      this.own(on(this._itemListObject, "show-filter", lang.hitch(this, function () {
        ...
        //Set first and last node once the filter panel is open
        jimuUtils.initFirstFocusNode(this.domNode, this.filterBackButton);
