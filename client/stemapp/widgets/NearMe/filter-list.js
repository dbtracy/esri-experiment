...
define([
  ...
  function (declare, FilterListTemplate, array, html, lang, query, on, domAttr, keys, _WidgetsInTemplateMixin, domClass,
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin, Evented], {
      ...
      _itemTemplate: '<li aria-label="${layerTitle}" role="button" tabindex="0" ' +
        ...
        '<span class="cando jimu-float-trailing jimu-leading-margin1 jimu-trailing-margin1 ">' +
        '</span>' +
        '<span class="doing jimu-float-trailing jimu-leading-margin1 jimu-trailing-margin1 ">' +
        '</span>' +
        '<span class="done jimu-float-trailing jimu-leading-margin1 jimu-trailing-margin1 ">'+
        '</span>' +
        '</div>' +
        '<div class="body">' +
