  ...
  return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
    ...
    postCreate: function () {
      ...
      if (this.bufferVisibilityCheckBox.checkNode) {
        this.own(on(this.bufferVisibilityCheckBox.checkNode, 'click', lang.hitch(this, this
          ._onVisibilityChange)));
      }
    ...
    **/
    ...
    setConfigForEditor: function () {
      ...
      if (this.config.noFeatureFoundMessage) {
        this._noFeatureMessageEditor.set("value", this.config.noFeatureFoundMessage);
      } else {
        this._noFeatureMessageEditor.set("value", this.nls.searchSetting.noFeatureFoundText);
      }
      //set configured text for search heading/ introduction of widget or else set a defalut msg
      if (!this.config.editorDescription) {
        this._introductionMessagetEditor.set("value", this.nls.searchSetting.searchHeaderText);
      }
      else {
        this._introductionMessagetEditor.set("value", this.config.editorDescription);
      }
    },
