...
define({
  ...
  "searchSetting": {
    ...
    "highlightColorLabel": "Выберите цвет для выборки",
    ...
    "showImageGalleryHint": "Подсказка: показанная галерея изображений на панели виджетов, если установлен флажок, иначе будет скрыто",
