...
define({
  ...
  "searchSetting": {
    ...
    "addressLocationPolygonHintText": "संकेत: निकटता खोज में उपयोग करने के लिए कॉन्फ़िगर की गई बहुभुज लेयर का प्रतीक।",
    "popupTitleForPolygon": "चयनित पता स्थान के लिए पॉलीगॉन का चयन करें",
    "popupTitleForPolyline": "पता स्थान के लिए लाइन का चयन करें",
    "addressLocationPolylineHintText": "संकेत: निकटता खोज में उपयोग करने के लिए कॉन्फ़िगर की गई पॉलीलाइन लेयर का प्रतीक।",
    "fontColorLabel": "खोज परिणामों के लिए फॉण्ट के रंग का चयन करें",
    "fontColorHintText": "सुझाव: खोज परिणामों का फॉण्ट रंग",
    "highlightColorLabel": "चयन के लिए रंग चुनें",
    "highlightColorHintText": "संकेत: चयन रंग",
    ...
    "showImageGalleryLabel": "छवि गैलरी दिखाएँ",
    "showImageGalleryHint": "संकेत: अगर चेकबॉक्स में सही का निशान लगा होगा, तो तो विजेट पैनल में दिखाई गई छवि गैलरी छुप जाएगी",
    "showResultCountOfLayerLabel": "प्रत्येक लेयर के लिए खोज परिणामों की गिनती दिखाएं",
    "showResultCountOfLayerHint": "संकेत: प्रत्येक लेयर नाम के बाद खोज परिणामों की संख्या प्रदर्शित करें",
    "editDescription": "परिचयात्मक पाठ",
    "editDescriptionTip": "खोज बॉक्स के ऊपर विजेट में प्रदर्शित पाठ।",
    "noResultsFound": "कोई परिणाम नहीं मिलने पर संदेश",
    "noResultFoundHint": "संकेत: खोज परिणाम के भीतर कोई परिणाम नहीं मिलने पर प्रदर्शन के लिए संदेश सेट करें",
    "noFeatureFoundText": "कोई परिणाम नहीं मिला ",
    "searchHeaderText": "पते की खोज करें या मैप पर स्थान निर्धारित करें",
    "setCurrentLocationLabel": "वर्तमान स्थान बटन सेट करें",
    "setCurrentLocationHintText": "संकेत: उपयोगकर्ता के वर्तमान स्थान का उपयोग करने के लिए बटन प्रदान करें"
  },
  "layerSelector": {
  ...
  "routeSetting": {
    ...
    "enableDirectionLabel": "दिशाओं को सक्षम करें",
    "enableDirectionText": "संकेत: विजेट में निर्देशों के सक्षम होने की जांच करें"
  },
  "symbologySetting": {
