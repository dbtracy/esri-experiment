...
define({
  ...
  "searchSetting": {
    ...
    "highlightColorLabel": "Trieu el color de selecció",
    ...
    "showImageGalleryHint": "Suggeriment: la galeria d'imatges es mostra a la subfinestra del widget si la casella de selecció està activada. Altrament, s'amaga.",
