...
define({
  ...
  "searchSetting": {
    ...
    "highlightColorLabel": "Вибрати колір вибору",
    ...
    "showImageGalleryHint": "Підказка: якщо прапорець встановлено в «істина», галерея зображень показуватиметься, в іншому випадку, вона приховуватиметься.",
