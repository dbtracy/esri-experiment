...
define({
  root: ({
    ...
    searchSetting: {
      ...
      highlightColorLabel: "Select the color for selection", //Show as label in config UI to set the selected highlight color in widget panel.
      ...
      showImageGalleryHint: "Hint: Shown image gallery in widget panel if checkbox in true else it will hide", // Shown as hint in config UI of image gallery
