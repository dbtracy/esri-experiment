...
define({
  ...
  "searchSetting": {
    ...
    "highlightColorLabel": "Seleccionar el color para la selección",
    ...
    "showImageGalleryHint": "Sugerencia: La galería de imágenes se mostrará en el panel del widget si el valor de la casilla de verificación es true; de lo contrario, se ocultará",
