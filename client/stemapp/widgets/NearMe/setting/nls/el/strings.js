...
define({
  ...
  "searchSetting": {
    ...
    "highlightColorLabel": "Επιλογή του χρώματος επιλογής",
    ...
    "showImageGalleryHint": "Υπόδειξη: Η συλλογή εικόνων θα εμφανίζεται στον πίνακα του widget αν στο πλαίσιο ελέγχου έχει επιλεχθεί η τιμή «Αληθής», ενώ αλλιώς θα είναι κρυμμένη.",
