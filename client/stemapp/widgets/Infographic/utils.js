...
define([
  ...
  var mo = {
    ...
    _getFieldInfo: function(fieldName, definition) {
      var fieldInfo = null;
    ...
    _isNumberType: function(fieldName, definition, containOID) {
    ...
    _upgradeAxisFormat: function(format, vertical, clusterField, type, definition, popupInfo) {
      ...
      if (!isValueAxis) { //means is label axis format
        var isNumberType = this._isNumberType(clusterField, definition, true);
        if(isNumberType){
