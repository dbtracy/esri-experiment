define({
  ...
  "widgetIntroSelectByArea": "以下のいずれかのツールを使用して、更新するフィーチャの選択セットを作成します。  行が<font class='maxRecordInIntro'>ハイライト表示</font>されている場合、レコードの最大数を超えています。",
  ...
  "widgetIntroSelectByFeatureQuery": "以下のツールを使用して、<font class='layerInIntro'>${0}</font> からフィーチャを選択します。  このフィーチャの <font class='layerInIntro'>${1}</font> 属性は、以下のレイヤーをクエリし、結果フィーチャを更新するために使用されます。  行が<font class='maxRecordInIntro'>ハイライト表示</font>されている場合、レコードの最大数を超えています。",
  "widgetIntroSelectByQuery": "値を入力して、選択セットを作成します。  行が<font class='maxRecordInIntro'>ハイライト表示</font>されている場合、レコードの最大数を超えています。"
});