define({
  ...
  "widgetIntroSelectByArea": "Pomocí jednoho z níže uvedených nástrojů vytvořte vybranou sadu prvků, které chcete aktualizovat. Pokud je řádek <font class='maxRecordInIntro'>zvýrazněn</font>, byl překročen maximální počet záznamů.",
  "widgetIntroSelectByFeature": "Pomocí níže uvedeného nástroje vyberte prvek z vrstvy <font class='layerInIntro'>${0}</font> .  Tento prvek se použije k výběru a aktualizování všech protínajících prvků. Pokud je řádek <font class='maxRecordInIntro'>zvýrazněn</font>, byl překročen maximální počet záznamů.",
  "widgetIntroSelectByFeatureQuery": "Pomocí níže uvedeného nástroje vyberte prvek z <font class='layerInIntro'>${0}</font> . Atribut tohoto prvku <font class='layerInIntro'>${1}</font> se použije k dotázání níže uvedených vrstev a aktualizaci výsledných prvků. Pokud je řádek <font class='maxRecordInIntro'>zvýrazněn</font>, byl překročen maximální počet záznamů.",
  "widgetIntroSelectByQuery": "Zadejte hodnotu, podle které chcete vytvořit sadu výběru. Pokud je řádek <font class='maxRecordInIntro'>zvýrazněn</font>, byl překročen maximální počet záznamů."
});