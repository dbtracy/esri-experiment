define({
  "page1": {
    ...
    "selectToolDesc": "Denne widgeten støtter tre ulike metoder for å generere et utvalg med poster som skal oppdateres. Du kan bare velge én av metodene. Hvis du har behov for å bruke flere av disse metodene, oppretter du en ny forekomst av widgeten.",
  ...
  "widgetIntroSelectByFeatureQuery": "Bruk verktøyet nedenfor til å velge et geoobjekt fra <font class='layerInIntro'>${0}</font>. Geoobjektets <font class='layerInIntro'>${1}</font>-attributt brukes til å spørre lagene nedenfor og oppdatere de resulterende geoobjektene. Hvis raden er <font class='maxRecordInIntro'>uthevet</font>, er maksimum antall poster overskredet.",
  "widgetIntroSelectByQuery": "Angi en verdi for å opprette et utvalgssett. Hvis raden er <font class='maxRecordInIntro'>uthevet</font>, er maksimum antall poster overskredet."
});