define({
  ...
  "widgetIntroSelectByArea": "Используйте один из указанных ниже инструментов для создания поднабора объектов для обновления. Если строка <font class='maxRecordInIntro'>подсвечена</font>, максимальное число записей превышено.",
  "widgetIntroSelectByFeature": "Используйте инструмент ниже, чтобы выбрать объект из слоя <font class='layerInIntro'>${0}</font>. Этот объект будет использован для выборки и обновления всех пересекающихся с ним объектов. Если строка <font class='maxRecordInIntro'>подсвечена</font>, максимальное число записей превышено.",
  "widgetIntroSelectByFeatureQuery": "Используйте инструмент ниже, чтобы выбрать объект из <font class='layerInIntro'>${0}</font> . Атрибут объекта <font class='layerInIntro'>${1}</font> будет использован для запроса указанных ниже слоев и обновления полученных объектов. Если строка <font class='maxRecordInIntro'>подсвечена</font>, максимальное число записей превышено.",
  "widgetIntroSelectByQuery": "Введите значение для создания выбранных наборов. Если строка <font class='maxRecordInIntro'>подсвечена</font>, максимальное число записей превышено.",
  "layerTable": {
    "colLabel": "Имя слоя",
    "numSelected": "#",
    "colSyncStatus": ""
