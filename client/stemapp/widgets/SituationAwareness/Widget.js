  ...
  function (declare, _WidgetsInTemplateMixin, Button,
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      postCreate: function() {
        ...
        this._isDrawToolSelected = false;
        ...
        if (lastNode) {
          if (num === 0) {
            if (!domClass.contains(this.clearIncident, "display-off")) {
              ...
              //Added flag to check if draw tool is selected manually by user
              //This helps in identifying if focus needs to be reset or not
              if (!this._isDrawToolSelected) {
                this.SA_btn0.focus();
              }
