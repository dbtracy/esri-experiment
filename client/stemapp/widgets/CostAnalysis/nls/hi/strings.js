...
define({
  ...
  "createLoadProject": {
    ...
    "errorFetchingPointLabel": "लेबल पॉइंट फ़ेच करते समय त्रुटि हुई। कृपया पुनः प्रयास करें",
    "errorAddingPointLabel": "लेबल पॉइंट जोड़ते समय त्रुटि हुई। कृपया पुनः प्रयास करें"
  },
  "statisticsSettings": {
  ...
  "updateCostEquationPanel": {
    "updateProjectCostTabLabel": "प्रोजेक्ट समीकरण अपडेट करें",
    "updateProjectCostSelectProjectTitle": "सभी प्रोजेक्ट चुनें",
    "updateButtonTextForm": "अपडेट करें",
    "updateProjectCostSuccess": "चयनित प्रोजेक्ट के लागत समीकरण अपडेट किए गए",
    "updateProjectCostError": "चयनित प्रोजेक्ट की लागत समीकरण अपडेट करने में असमर्थ",
    "updateProjectNoProject": "कोई प्रोजेक्ट नहीं मिला"
  }
});