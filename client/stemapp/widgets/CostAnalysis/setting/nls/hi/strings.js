...
define({
  ...
  "projectSettings": {
    ...
    "pointLayerCentroidLabel": "प्वाइंट लेयर सेंट्रोइड",
    "selectRelatedPointLayerDefaultOption": "चुनें",
    "pointLayerHintText": "निम्नलिखित शर्तों के साथ <p> पॉइंट के लेयर को दिखाया जाएगा: <br/> <li>\tलेयर में ‘Projectid’ (GUID प्रकार) फ़ील्ड होनी चाहिए</li><li>\tलेयर में संपादन क्षमताएँ होनी चाहिए जैसे कि ‘बनाएँ', ‘हटाएँ’ और ‘अपडेट करें’</li></p>"
  },
  "layerSettings": {
    ...
    "update": "अपडेट करें",
    "delete": "हटाएँ",
    "attributeSettingHeaderTitle": "विशेषता सेटिंग",
    "addFieldLabelTitle": "विशेषता जोड़ें",
    "layerAttributesHeaderTitle": "लेयर की विशेषताएँ",
    "projectLayerAttributesHeaderTitle": "प्रोजेक्ट लेयर की विशेषताएँ",
    "attributeSettingsPopupTitle": "लेयर विशेषता सेटिंग"
  },
  "costingInfo": {
    ...
    "updateProjectCostCheckboxLabel": "प्रोजेक्ट समीकरण अपडेट करें",
    "updateProjectCostEquationHint": "संकेत: यह उपयोगकर्ता को मौजूदा टेम्पलेट में जोड़ी गई परिसंपत्तियों के लागत समीकरणों को अपडेट करने की अनुमति देगा, जो सुविधा टेम्पलेट, भूगोल और परिदृश्य के आधार पर नीचे परिभाषित नए समीकरणों के साथ होंगे। यदि संयोजन नहीं मिला है, तो इसे डिफ़ॉल्ट लागत समीकरण यानी भूगोल और परिदृश्य पर 'कोई नहीं' के रूप में सेट किया जाएगा। हटाए गए सुविधा टेम्पलेट के मामले में, लागत 0 के रूप में सेट की जाएगी।"
  },
  "statisticsSettings": {
    "tabTitle": "अतिरिक्त सेटिंग",
  ...
  "projectCostSettings": {
    "addProjectCostLabel": "अतिरिक्त प्रोजेक्ट लागत जोड़ें",
    "additionalCostValueColumnHeader": "मान",
    "invalidProjectCostMessage": "प्रोजेक्ट लागत के लिए अमान्य प्रवेश",
    "additionalCostLabelColumnHeader": "लेबल",
    "additionalCostTypeColumnHeader": "टाइप करें"
  },
  "statisticsType": {
