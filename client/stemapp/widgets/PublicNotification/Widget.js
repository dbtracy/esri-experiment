  ...
  SearchLayers
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin, Evented], {
      ...
      _unionNonBufferdFeatures: function (bufferGeometry, nonBufferedFeatures) {
        ...
        if (bufferGeometry) {
          arrayOfGeometiesForUnion = [bufferGeometry].concat(nonBufferedGeometries)
        } else {
          arrayOfGeometiesForUnion = nonBufferedGeometries;
        }
        this._queryer.createUnionOfGeometries(arrayOfGeometiesForUnion)
          .then(lang.hitch(this, function (nonBufferedGeomUnion) {
            ...
            this._bufferGeometry = nonBufferedGeomUnion;
