...
define([
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    _initEditor: function () {
      ...
      this.own(on(this._editorObj, "focus", lang.hitch(this, function () {
        if (this._editorObj.get("value") === this.nls.inputOutputTab.enterDisplayText) {
    ...
    _createFieldSelector: function (container, textNode, fieldsArray) {
      ...
      fieldSelector.onSelect = lang.hitch(this, function (sectedField) {
        var newLabel;
        if (textNode.get("value") === this.nls.inputOutputTab.enterDisplayText) {
          textNode.set("value", "");
        }
