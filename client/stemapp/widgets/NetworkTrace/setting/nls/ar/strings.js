define({
  ...
  "projectSetting": {
    ...
    "selectLabel": "تحديد",
    "polygonLayerHelp": "<p>سيتم عرض طبقات المضلع ذات الشروط التالية:<br/><ul><li>يجب أن يكون للطبقة قدرات تحريرية أي \"الإنشاء\" و\"الحذف\" و\"التحديث\"</li><li>يجب أن يكون للطبقة حقلان بنفس الاسم ونوع البيانات:</li><ul><li>الاسم (حقل نوع السلسلة)</li><li>المعرف العالمي (حقل نوع المعرف العالمي)</li></ul></ul><p/>",
    "outputParameterHelp": "<p>سيتم عرض طبقات مضلع الإخراج من URL المهمة<p/>",
    "pointLayerHelp": "<p>سيتم عرض طبقات النقطة ذات الشروط التالية:<br/><ul><li>يجب أن يكون للطبقة قدرات تحريرية أي \"الإنشاء\" و\"الحذف\" و\"التحديث\"</li><li>يجب أن يكون للطبقة حقلان بنفس الاسم ونوع البيانات:</li><ul><li>نوع الإدخال (حقل نوع السلسلة)</li><li>معرف المشروع (حقل نوع الدليل)</li></ul></ul><p/>"
  },
  "inputOutputTab": {
  ...
  "summaryTab": {
    ...
    "autoZoomAfterTrace": "خيارات إضافية",
