define({
  ...
  "description": "Navigieren Sie zu einer <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'> Tabelle</a> bzw. legen Sie hier eine ab, um sie zu visualisieren und Daten daran anzuhängen.",
  "selectCSV": "CSV auswählen",
  "loadingCSV": "CSV wird geladen",
  "savingCSV": "CSVExport",
  ...
  "projectionLat": "Breitengrad/Längengrad",
  "projectionMap": "Kartenprojektion",
  "messages": "Meldungen",
  "error": {
    "fetchingCSV": "Fehler beim Abrufen von Elementen aus dem CSV-Speicher: ${0}",
    "fileIssue": "Die Datei konnte nicht verarbeitet werden.",
    "notCSVFile": "Derzeit werden nur kommagetrennte Dateien (.csv) unterstützt.",
    "invalidCoord": "Positionsfelder sind ungültig. Überprüfen Sie die CSV-Datei.",
    "tooManyRecords": "Zurzeit leider nicht mehr als ${0} Datensätze.",
    "CSVNoRecords": "Die Datei enthält keine Datensätze.",
    "CSVEmptyFile": "Kein Inhalt in der Datei."
  },
  "results": {
