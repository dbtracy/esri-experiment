define({
  ...
  "description": "Gå til eller dra et <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Last ned eksempelark' target='_blank'> regneark</a> hit for å visualisere og legge til kartdata i det.",
  ...
  "error": {
    ...
    "invalidCoord": "Ugyldige lokasjonsfelt. Kontroller CSV-filen.",
