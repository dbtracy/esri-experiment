define({
  ...
  "description": "Naršykite arba nuvilkite <a href='./widgets/GeoLookup/data/sample.csv' tooltip='Download an example sheet' target='_blank'> darbalapį </a> čia, jei norite jį vizualizuoti arba įtraukti į jį žemėlapio duomenis.",
  ...
  "projectionChoice": "CSV, esantis",
  "projectionLat": "Platuma / ilguma",
  "projectionMap": "Žemėlapio projekcija",
  "messages": "Pranešimai",
  "error": {
    ...
    "invalidCoord": "Vietos laukai yra netinkami. Patikrinkite CSV failą.",
    "tooManyRecords": "Deja, šiuo metu galimi ne daugiau kaip ${0} įrašai.",
    "CSVNoRecords": "Faile nėra jokių įrašų.",
    "CSVEmptyFile": "Faile nėra turinio."
  },
  "results": {
