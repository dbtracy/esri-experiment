...
define([
  ...
  function (array, declare, domClass, domConstruct, domStyle, query, when, _TemplatedMixin, _WidgetBase, _WidgetsInTemplateMixin, SelectableTree, ReportPlayer, PlayerResizeModes, PlayerThemes, DataProviderGE, PlayerCommands,
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WizardPage, _WidgetsInTemplateMixin], {
      ...
      _hideOrShowTabs: function () {
        ...
        if (this.infographicsTabHidden) {
          this.tab.removeTab(this.nls.infographics);
          this.tab.selectTab(this.nls.reports);
        }

        if (this.reportsTabHidden) {
          this.tab.removeTab(this.nls.reports);
      ...
      runInfographic: function () {
        ...
        this.reportPlayer = new ReportPlayer({
          ...
          config: {
            esriDijitCssUrl: "https://js.arcgis.com/3.29/dijit/themes/claro/claro.css",
            esriCssUrl: "https://js.arcgis.com/3.29/esri/css/esri.css",
            playerSourceRootUrl: "https://js.arcgis.com/3.29/"
          },
          onClose: function () {
        ...
        var runPlayer = function (reportID) {
          ...
          if (self.wizard.selectedPoint.long) {
            ...
            array.forEach(self.wizard.selectedPoint.tradeAreas, function (tradeArea) {
              var analysisArea = {};
      ...
      runReportForPolygon: function () {
        ...
        var studyArea = {
          geometry: this.wizard.selectedPolygon.geometry
        };
