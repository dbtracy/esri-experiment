...
define([
  ...
  function (declare, _TemplatedMixin, _WidgetBase, _WidgetsInTemplateMixin, _WizardPage, Polygon, SimpleFillSymbol, SimpleLineSymbol, Color, Graphic, GEUtil, TravelModeUtil, ValidationUtil, template, TabContainer) {
